...
const SECTIONS = [
  ...
  { href: "#", title: "Batch", desc: "Generate a J-J-J-H set for the week.", ready: false },
  { href: "#", title: "Calendar", desc: "Schedule posts and eyeball the jab/hook ratio.", ready: false },
